...
//
// Generated by ConcreteChoiceSerializationGenerator for Code.  ISO2002 ID# _P_4pRNp-Ed-ak6NoX_4Aeg_2056543161.
...
using Code = BeneficialStrategies.Iso20022.Choices.PersonIdentificationSchemeName1Choice.Code;
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.Choices.PersonIdentificationSchemeName1Choice
{
    ...
    /// </summary>
    public class PersonIdentificationSchemeName1ChoiceCodeXmlAsyncWriter : ISubordinateXmlAsyncWriter<Code>
    {
        // Injected dependencies for serialization of each member data type
        private readonly ExternalPersonIdentification1CodeXmlAsyncWriter value;
        
        /// <summary>
        /// Construct using an injected writer for each member.
        /// </summary>
        public PersonIdentificationSchemeName1ChoiceCodeXmlAsyncWriter
        (
            ExternalPersonIdentification1CodeXmlAsyncWriter value
        )
        {
            this.value = value;
        }
        public async Task WriteAsync(XmlWriter writer, Code valueBeingSerialized, string isoNamespace)
        {
            ...
            // Value Required ExternalPersonIdentification1Code ExternalPersonIdentification1Code
