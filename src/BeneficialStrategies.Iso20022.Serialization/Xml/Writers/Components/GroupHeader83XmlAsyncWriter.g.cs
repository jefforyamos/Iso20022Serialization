...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.Components
{
    ...
    /// </summary>
    public class GroupHeader83XmlAsyncWriter
    ( // primary constructor 
        ...
        ISubordinateXmlAsyncWriter<BranchAndFinancialInstitutionIdentification6> forwardingAgent
            ...
            : ISubordinateXmlAsyncWriter<GroupHeader83>
    {
        public async Task WriteAsync(XmlWriter writer, GroupHeader83 value, string isoNamespace)
        {
