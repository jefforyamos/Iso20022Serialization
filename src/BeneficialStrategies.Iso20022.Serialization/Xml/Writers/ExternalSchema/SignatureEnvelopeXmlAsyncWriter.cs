...
//
// Generated by ExternalSchemaSerializationClassGenerator for SignatureEnvelope.  ISO2002 ID# _O-3vQKYkEeS0NIlWNmtQyw.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.ExternalSchema
{
    ...
    /// </summary>
    public class SignatureEnvelopeXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<SignatureEnvelope>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;SignatureEnvelope&apos; should be formatted.
        /// Coerce the value when possible or truncate text that is too long.
        /// Can be overridden by subclass with inheritance.
        /// </summary>
        public virtual Task WriteAsync(XmlWriter writer, SignatureEnvelope value, string isoNamespace)
        {
