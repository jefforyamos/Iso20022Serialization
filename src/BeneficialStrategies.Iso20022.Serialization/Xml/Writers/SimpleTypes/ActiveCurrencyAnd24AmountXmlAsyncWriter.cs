...
//
// Generated by SimpleTypeSerializationClassGenerator for ActiveCurrencyAnd24Amount.  ISO2002 ID# _cuFukzTxEemwtJBLtapBmw.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class ActiveCurrencyAnd24AmountXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.Decimal>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;ActiveCurrencyAnd24Amount&apos; should be formatted.
