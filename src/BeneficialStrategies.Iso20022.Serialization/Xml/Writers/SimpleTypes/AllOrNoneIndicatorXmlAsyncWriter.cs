...
//
// Generated by SimpleTypeSerializationClassGenerator for AllOrNoneIndicator.  ISO2002 ID# _YXSZE9p-Ed-ak6NoX_4Aeg_2104189385.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class AllOrNoneIndicatorXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;AllOrNoneIndicator&apos; should be formatted.
