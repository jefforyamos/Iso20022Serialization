...
//
// Generated by SimpleTypeSerializationClassGenerator for Bloomberg2Identifier.  ISO2002 ID# _vwu6IVonEeaGcYxFfqiPNw.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Bloomberg2IdentifierXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Bloomberg2Identifier&apos; should be formatted.
