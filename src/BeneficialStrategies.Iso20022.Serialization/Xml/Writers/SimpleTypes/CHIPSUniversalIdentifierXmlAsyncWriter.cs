...
//
// Generated by SimpleTypeSerializationClassGenerator for CHIPSUniversalIdentifier.  ISO2002 ID# _YXIoEdp-Ed-ak6NoX_4Aeg_-870708024.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class CHIPSUniversalIdentifierXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;CHIPSUniversalIdentifier&apos; should be formatted.
