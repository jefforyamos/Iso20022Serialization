...
//
// Generated by SimpleTypeSerializationClassGenerator for CanadianPaymentsARNIdentifier.  ISO2002 ID# _YXIoF9p-Ed-ak6NoX_4Aeg_-870707956.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class CanadianPaymentsARNIdentifierXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;CanadianPaymentsARNIdentifier&apos; should be formatted.
