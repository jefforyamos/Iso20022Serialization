...
//
// Generated by SimpleTypeSerializationClassGenerator for ChargeIncludedIndicator.  ISO2002 ID# _YXSZFdp-Ed-ak6NoX_4Aeg_536141126.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class ChargeIncludedIndicatorXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;ChargeIncludedIndicator&apos; should be formatted.
