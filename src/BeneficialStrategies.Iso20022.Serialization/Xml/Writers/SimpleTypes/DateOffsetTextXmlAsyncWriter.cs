...
//
// Generated by SimpleTypeSerializationClassGenerator for DateOffsetText.  ISO2002 ID# _RuDV8JVJEeaYkf5FCqYMeA.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class DateOffsetTextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;DateOffsetText&apos; should be formatted.
