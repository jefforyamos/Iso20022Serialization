...
//
// Generated by SimpleTypeSerializationClassGenerator for DirectionIndicator.  ISO2002 ID# _YYn119p-Ed-ak6NoX_4Aeg_-164452646.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class DirectionIndicatorXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;DirectionIndicator&apos; should be formatted.
