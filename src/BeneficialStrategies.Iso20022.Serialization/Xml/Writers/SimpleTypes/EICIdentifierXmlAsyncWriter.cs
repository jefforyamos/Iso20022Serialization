...
//
// Generated by SimpleTypeSerializationClassGenerator for EICIdentifier.  ISO2002 ID# _PBKoEA3cEeW9YKj3GUmIEw.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class EICIdentifierXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;EICIdentifier&apos; should be formatted.
