...
//
// Generated by SimpleTypeSerializationClassGenerator for Exact15Text.  ISO2002 ID# _jAfi0ER8Eeeb1MmUPTrSMw.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Exact15TextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Exact15Text&apos; should be formatted.
