...
//
// Generated by SimpleTypeSerializationClassGenerator for Exact2AlphaNumericText.  ISO2002 ID# _Y9tR0ZUNEeak6e8_Fc5fQg.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Exact2AlphaNumericTextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Exact2AlphaNumericText&apos; should be formatted.
