...
//
// Generated by SimpleTypeSerializationClassGenerator for Exact2UpperCaseAlphaText.  ISO2002 ID# _KfOYUevdEeicVrqVCtzH5g.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Exact2UpperCaseAlphaTextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Exact2UpperCaseAlphaText&apos; should be formatted.
