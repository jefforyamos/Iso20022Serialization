...
//
// Generated by SimpleTypeSerializationClassGenerator for Exact32AlphaNumericText.  ISO2002 ID# _W7-JAnh2EeOF3uSOaAf1Lg.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Exact32AlphaNumericTextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Exact32AlphaNumericText&apos; should be formatted.
