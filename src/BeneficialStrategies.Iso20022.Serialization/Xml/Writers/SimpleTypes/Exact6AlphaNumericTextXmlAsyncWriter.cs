...
//
// Generated by SimpleTypeSerializationClassGenerator for Exact6AlphaNumericText.  ISO2002 ID# _D9usQVKcEeeFcfYfFkVztg.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Exact6AlphaNumericTextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Exact6AlphaNumericText&apos; should be formatted.
