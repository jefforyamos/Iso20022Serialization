//
// Generated by SimpleTypeSerializationClassGenerator for Fraction5DecimalNumber.  ISO2002 ID# _fGXGITT0EemwtJBLtapBmw.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Fraction5DecimalNumberXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.UInt64>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Fraction5DecimalNumber&apos; should be formatted.
