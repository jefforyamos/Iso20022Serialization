...
//
// Generated by SimpleTypeSerializationClassGenerator for GeographicPointInDecimalDegrees.  ISO2002 ID# _tpibgMWMEeuhguwJmlgagQ.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class GeographicPointInDecimalDegreesXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;GeographicPointInDecimalDegrees&apos; should be formatted.
