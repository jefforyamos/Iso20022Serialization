...
//
// Generated by SimpleTypeSerializationClassGenerator for HellenicBankIdentificationCodeIdentifier.  ISO2002 ID# _YYer59p-Ed-ak6NoX_4Aeg_527753128.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class HellenicBankIdentificationCodeIdentifierXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;HellenicBankIdentificationCodeIdentifier&apos; should be formatted.
