...
//
// Generated by SimpleTypeSerializationClassGenerator for HongKongBankIdentifier.  ISO2002 ID# _YXSZENp-Ed-ak6NoX_4Aeg_-870707946.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class HongKongBankIdentifierXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;HongKongBankIdentifier&apos; should be formatted.
