...
//
// Generated by SimpleTypeSerializationClassGenerator for ISICIdentifier.  ISO2002 ID# _d8h_EI5_EemzmeK8_tPygg.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class ISICIdentifierXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;ISICIdentifier&apos; should be formatted.
