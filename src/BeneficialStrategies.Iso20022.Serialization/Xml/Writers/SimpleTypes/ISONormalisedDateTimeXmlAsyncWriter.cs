...
//
// Generated by SimpleTypeSerializationClassGenerator for ISONormalisedDateTime.  ISO2002 ID# _YWPQN9p-Ed-ak6NoX_4Aeg_-842130097.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class ISONormalisedDateTimeXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.DateTime>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;ISONormalisedDateTime&apos; should be formatted.
