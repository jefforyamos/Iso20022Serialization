...
//
// Generated by SimpleTypeSerializationClassGenerator for ISORestrictedYear.  ISO2002 ID# _0XTF8Q25EeWmAKKPnqYEVQ.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class ISORestrictedYearXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.UInt16>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;ISORestrictedYear&apos; should be formatted.
