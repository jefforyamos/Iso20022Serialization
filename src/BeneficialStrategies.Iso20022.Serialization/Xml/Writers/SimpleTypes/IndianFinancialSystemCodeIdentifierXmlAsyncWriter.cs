...
//
// Generated by SimpleTypeSerializationClassGenerator for IndianFinancialSystemCodeIdentifier.  ISO2002 ID# _YYn10Np-Ed-ak6NoX_4Aeg_-1110573084.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class IndianFinancialSystemCodeIdentifierXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;IndianFinancialSystemCodeIdentifier&apos; should be formatted.
