...
//
// Generated by SimpleTypeSerializationClassGenerator for ItalianDomesticIdentifier.  ISO2002 ID# _YXIoFNp-Ed-ak6NoX_4Aeg_-870707989.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class ItalianDomesticIdentifierXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;ItalianDomesticIdentifier&apos; should be formatted.
