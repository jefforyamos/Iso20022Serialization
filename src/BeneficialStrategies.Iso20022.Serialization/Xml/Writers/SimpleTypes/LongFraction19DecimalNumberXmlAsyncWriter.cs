...
//
// Generated by SimpleTypeSerializationClassGenerator for LongFraction19DecimalNumber.  ISO2002 ID# _-J5vIQbIEeqrW7Meu5r3kQ.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class LongFraction19DecimalNumberXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.UInt64>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;LongFraction19DecimalNumber&apos; should be formatted.
