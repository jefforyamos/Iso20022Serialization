...
//
// Generated by SimpleTypeSerializationClassGenerator for Max100AlphaNumericUnderscoreText.  ISO2002 ID# _DOWBAaMbEeWZDvWHgGXs7Q.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Max100AlphaNumericUnderscoreTextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Max100AlphaNumericUnderscoreText&apos; should be formatted.
