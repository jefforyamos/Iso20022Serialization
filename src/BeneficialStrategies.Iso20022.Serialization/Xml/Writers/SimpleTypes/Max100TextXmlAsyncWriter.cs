...
//
// Generated by SimpleTypeSerializationClassGenerator for Max100Text.  ISO2002 ID# _F7fQUCRlEemoiMEiwtMpyw.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Max100TextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Max100Text&apos; should be formatted.
