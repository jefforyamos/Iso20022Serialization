...
//
// Generated by SimpleTypeSerializationClassGenerator for Max10KHexBinaryText.  ISO2002 ID# _gsRgsJKOEempjNUC7bi_Ng.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Max10KHexBinaryTextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Max10KHexBinaryText&apos; should be formatted.
