...
//
// Generated by SimpleTypeSerializationClassGenerator for Max12NumericText.  ISO2002 ID# _fHvagER6Eeeb1MmUPTrSMw.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Max12NumericTextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Max12NumericText&apos; should be formatted.
