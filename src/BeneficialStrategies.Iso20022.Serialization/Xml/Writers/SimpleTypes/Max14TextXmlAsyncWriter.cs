...
//
// Generated by SimpleTypeSerializationClassGenerator for Max14Text.  ISO2002 ID# _mUfg0aMaEeWZDvWHgGXs7Q.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Max14TextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Max14Text&apos; should be formatted.
