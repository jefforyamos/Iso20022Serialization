...
//
// Generated by SimpleTypeSerializationClassGenerator for Max16HexBinaryText.  ISO2002 ID# _ckUlAJaNEemfCcEf5rVTyg.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Max16HexBinaryTextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Max16HexBinaryText&apos; should be formatted.
