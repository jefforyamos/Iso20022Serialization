...
//
// Generated by SimpleTypeSerializationClassGenerator for Max16Text.  ISO2002 ID# _YW1tJ9p-Ed-ak6NoX_4Aeg_-185393449.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Max16TextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Max16Text&apos; should be formatted.
