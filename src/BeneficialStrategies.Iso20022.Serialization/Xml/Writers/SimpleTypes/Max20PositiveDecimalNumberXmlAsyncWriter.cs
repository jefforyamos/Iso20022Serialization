//
// Generated by SimpleTypeSerializationClassGenerator for Max20PositiveDecimalNumber.  ISO2002 ID# _EMAC8e3tEeaWjpoyrnG6Rw.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Max20PositiveDecimalNumberXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.UInt64>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Max20PositiveDecimalNumber&apos; should be formatted.
