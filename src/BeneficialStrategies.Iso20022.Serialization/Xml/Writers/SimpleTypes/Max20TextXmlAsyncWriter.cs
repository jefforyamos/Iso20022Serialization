...
//
// Generated by SimpleTypeSerializationClassGenerator for Max20Text.  ISO2002 ID# _6WzSkJqlEeGSON8vddiWzQ_-2085735640.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Max20TextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Max20Text&apos; should be formatted.
