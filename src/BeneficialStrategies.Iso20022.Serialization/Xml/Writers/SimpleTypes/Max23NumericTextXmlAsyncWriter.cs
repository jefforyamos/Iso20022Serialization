...
//
// Generated by SimpleTypeSerializationClassGenerator for Max23NumericText.  ISO2002 ID# _UxkpMESAEeeb1MmUPTrSMw.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Max23NumericTextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Max23NumericText&apos; should be formatted.
