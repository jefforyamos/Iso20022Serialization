...
//
// Generated by SimpleTypeSerializationClassGenerator for Max240Text.  ISO2002 ID# _pMhwAFO5EeGs_NnqHXQZkw.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Max240TextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Max240Text&apos; should be formatted.
