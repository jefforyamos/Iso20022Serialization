...
//
// Generated by SimpleTypeSerializationClassGenerator for Max2KBinary.  ISO2002 ID# _iAksQRJZEeWg-NN-FmovgQ.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Max2KBinaryXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.Byte[]>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Max2KBinary&apos; should be formatted.
