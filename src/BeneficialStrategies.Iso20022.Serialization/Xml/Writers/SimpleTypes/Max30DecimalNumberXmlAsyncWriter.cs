//
// Generated by SimpleTypeSerializationClassGenerator for Max30DecimalNumber.  ISO2002 ID# _xNcaMBrKEeyhRdHRjakS2w.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Max30DecimalNumberXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.UInt64>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Max30DecimalNumber&apos; should be formatted.
