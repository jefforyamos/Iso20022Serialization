...
//
// Generated by SimpleTypeSerializationClassGenerator for Max37Text.  ISO2002 ID# __xN7MI0TEeWRYffwL7E13A.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Max37TextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Max37Text&apos; should be formatted.
