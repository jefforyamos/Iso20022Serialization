...
//
// Generated by SimpleTypeSerializationClassGenerator for Max40KText.  ISO2002 ID# _YnWrADHQEeyTT91yHXSlSQ.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Max40KTextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Max40KText&apos; should be formatted.
