...
//
// Generated by SimpleTypeSerializationClassGenerator for Max5Text.  ISO2002 ID# _VtwzAF6yEeaXOLVjLqkyTQ.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Max5TextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Max5Text&apos; should be formatted.
