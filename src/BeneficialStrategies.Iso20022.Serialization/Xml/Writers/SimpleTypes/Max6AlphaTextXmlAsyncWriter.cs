...
//
// Generated by SimpleTypeSerializationClassGenerator for Max6AlphaText.  ISO2002 ID# _RkngMJUUEea7vKctaoIyEQ.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Max6AlphaTextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Max6AlphaText&apos; should be formatted.
