...
//
// Generated by SimpleTypeSerializationClassGenerator for Max6NumericText.  ISO2002 ID# _8P6HgYkDEeiUdscb3zN7pw.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Max6NumericTextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Max6NumericText&apos; should be formatted.
