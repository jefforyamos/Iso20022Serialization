...
//
// Generated by SimpleTypeSerializationClassGenerator for Max8NumericText.  ISO2002 ID# _2Azj0EqXEeenp6hmNprBHg.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Max8NumericTextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Max8NumericText&apos; should be formatted.
