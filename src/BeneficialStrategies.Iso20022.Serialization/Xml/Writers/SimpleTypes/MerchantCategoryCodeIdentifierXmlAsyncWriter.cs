...
//
// Generated by SimpleTypeSerializationClassGenerator for MerchantCategoryCodeIdentifier.  ISO2002 ID# _I15MoXFsEemaN4ndAVY1ZQ.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class MerchantCategoryCodeIdentifierXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;MerchantCategoryCodeIdentifier&apos; should be formatted.
