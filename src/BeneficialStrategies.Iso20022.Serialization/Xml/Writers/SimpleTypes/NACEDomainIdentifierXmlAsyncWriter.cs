...
//
// Generated by SimpleTypeSerializationClassGenerator for NACEDomainIdentifier.  ISO2002 ID# _VHNvASrVEeWVAsq7ECcp5g.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class NACEDomainIdentifierXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;NACEDomainIdentifier&apos; should be formatted.
