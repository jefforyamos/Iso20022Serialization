...
//
// Generated by SimpleTypeSerializationClassGenerator for NewZealandNCCIdentifier.  ISO2002 ID# _YXIoENp-Ed-ak6NoX_4Aeg_-870708035.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class NewZealandNCCIdentifierXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;NewZealandNCCIdentifier&apos; should be formatted.
