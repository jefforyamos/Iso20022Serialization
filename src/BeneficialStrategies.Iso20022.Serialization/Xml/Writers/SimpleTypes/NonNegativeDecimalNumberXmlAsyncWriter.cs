//
// Generated by SimpleTypeSerializationClassGenerator for NonNegativeDecimalNumber.  ISO2002 ID# _mX4tAyGwEeKjd4jizyIDGA.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class NonNegativeDecimalNumberXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.UInt64>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;NonNegativeDecimalNumber&apos; should be formatted.
