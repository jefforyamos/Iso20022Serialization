//
// Generated by SimpleTypeSerializationClassGenerator for NonNegativeFraction5DecimalNumber.  ISO2002 ID# _F6uCoVHGEeeqtLmveSCYmA.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class NonNegativeFraction5DecimalNumberXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.UInt64>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;NonNegativeFraction5DecimalNumber&apos; should be formatted.
