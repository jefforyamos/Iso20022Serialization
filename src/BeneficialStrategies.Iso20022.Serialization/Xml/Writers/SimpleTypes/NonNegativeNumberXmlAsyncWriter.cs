//
// Generated by SimpleTypeSerializationClassGenerator for NonNegativeNumber.  ISO2002 ID# _UJsWsFGuEeeqtLmveSCYmA.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class NonNegativeNumberXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.UInt64>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;NonNegativeNumber&apos; should be formatted.
