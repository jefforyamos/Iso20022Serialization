//
// Generated by SimpleTypeSerializationClassGenerator for Number.  ISO2002 ID# _YXbjBtp-Ed-ak6NoX_4Aeg_1560899033.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class NumberXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.UInt64>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Number&apos; should be formatted.
