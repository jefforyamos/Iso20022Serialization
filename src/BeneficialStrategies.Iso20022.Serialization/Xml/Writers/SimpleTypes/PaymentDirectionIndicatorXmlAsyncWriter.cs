...
//
// Generated by SimpleTypeSerializationClassGenerator for PaymentDirectionIndicator.  ISO2002 ID# _YXSZEtp-Ed-ak6NoX_4Aeg_184468952.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class PaymentDirectionIndicatorXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;PaymentDirectionIndicator&apos; should be formatted.
