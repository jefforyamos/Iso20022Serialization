...
//
// Generated by SimpleTypeSerializationClassGenerator for PlusOrMinusIndicator.  ISO2002 ID# _YXvFA9p-Ed-ak6NoX_4Aeg_143431681.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class PlusOrMinusIndicatorXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;PlusOrMinusIndicator&apos; should be formatted.
