...
//
// Generated by SimpleTypeSerializationClassGenerator for PortugueseNCCIdentifier.  ISO2002 ID# _YXIoE9p-Ed-ak6NoX_4Aeg_-870707992.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class PortugueseNCCIdentifierXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;PortugueseNCCIdentifier&apos; should be formatted.
