...
//
// Generated by SimpleTypeSerializationClassGenerator for PositiveNumber.  ISO2002 ID# _AlfR4c_dEeWjSMe6YTKHlQ.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class PositiveNumberXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.UInt64>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;PositiveNumber&apos; should be formatted.
