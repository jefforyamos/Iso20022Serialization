...
//
// Generated by SimpleTypeSerializationClassGenerator for PreviousAll.  ISO2002 ID# _YYxm2Np-Ed-ak6NoX_4Aeg_-1132097713.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class PreviousAllXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;PreviousAll&apos; should be formatted.
