...
//
// Generated by SimpleTypeSerializationClassGenerator for Refused7Text.  ISO2002 ID# _06pitjg0EeKfZIj_SwVRwA.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class Refused7TextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;Refused7Text&apos; should be formatted.
