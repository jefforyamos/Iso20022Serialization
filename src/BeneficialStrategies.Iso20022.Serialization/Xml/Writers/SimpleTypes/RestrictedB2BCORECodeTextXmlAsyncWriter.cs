...
//
// Generated by SimpleTypeSerializationClassGenerator for RestrictedB2BCORECodeText.  ISO2002 ID# _VwsKQtp-Ed-ak6NoX_4Aeg_-1706550180.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class RestrictedB2BCORECodeTextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;RestrictedB2BCORECodeText&apos; should be formatted.
