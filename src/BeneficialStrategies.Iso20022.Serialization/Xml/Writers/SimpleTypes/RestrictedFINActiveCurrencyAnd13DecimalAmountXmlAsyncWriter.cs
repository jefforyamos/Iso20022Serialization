...
//
// Generated by SimpleTypeSerializationClassGenerator for RestrictedFINActiveCurrencyAnd13DecimalAmount.  ISO2002 ID# _WN5Dptp-Ed-ak6NoX_4Aeg_-154812387.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class RestrictedFINActiveCurrencyAnd13DecimalAmountXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.Decimal>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;RestrictedFINActiveCurrencyAnd13DecimalAmount&apos; should be formatted.
