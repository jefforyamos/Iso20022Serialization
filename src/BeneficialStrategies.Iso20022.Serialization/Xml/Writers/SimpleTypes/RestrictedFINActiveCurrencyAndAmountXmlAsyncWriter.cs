...
//
// Generated by SimpleTypeSerializationClassGenerator for RestrictedFINActiveCurrencyAndAmount.  ISO2002 ID# _WOVvkNp-Ed-ak6NoX_4Aeg_-1267706960.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class RestrictedFINActiveCurrencyAndAmountXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.Decimal>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;RestrictedFINActiveCurrencyAndAmount&apos; should be formatted.
