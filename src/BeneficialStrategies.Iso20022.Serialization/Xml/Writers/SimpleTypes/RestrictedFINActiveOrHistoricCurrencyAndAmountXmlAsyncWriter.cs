...
//
// Generated by SimpleTypeSerializationClassGenerator for RestrictedFINActiveOrHistoricCurrencyAndAmount.  ISO2002 ID# _XY_k3tp-Ed-ak6NoX_4Aeg_1054967173.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class RestrictedFINActiveOrHistoricCurrencyAndAmountXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.Decimal>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;RestrictedFINActiveOrHistoricCurrencyAndAmount&apos; should be formatted.
