...
//
// Generated by SimpleTypeSerializationClassGenerator for RestrictedFINImpliedCurrencyAndAmount.  ISO2002 ID# _XZJV1Np-Ed-ak6NoX_4Aeg_681057429.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class RestrictedFINImpliedCurrencyAndAmountXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.Decimal>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;RestrictedFINImpliedCurrencyAndAmount&apos; should be formatted.
