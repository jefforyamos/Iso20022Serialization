...
//
// Generated by SimpleTypeSerializationClassGenerator for RestrictedFINMax34Text.  ISO2002 ID# _WOpRk9p-Ed-ak6NoX_4Aeg_-690874553.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class RestrictedFINMax34TextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;RestrictedFINMax34Text&apos; should be formatted.
