...
//
// Generated by SimpleTypeSerializationClassGenerator for RestrictedFINXMax140Text.  ISO2002 ID# _XZJV19p-Ed-ak6NoX_4Aeg_-1471472211.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class RestrictedFINXMax140TextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;RestrictedFINXMax140Text&apos; should be formatted.
