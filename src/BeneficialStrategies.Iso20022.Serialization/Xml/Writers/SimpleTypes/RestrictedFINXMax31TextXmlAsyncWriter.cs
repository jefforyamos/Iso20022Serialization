...
//
// Generated by SimpleTypeSerializationClassGenerator for RestrictedFINXMax31Text.  ISO2002 ID# _XZTG09p-Ed-ak6NoX_4Aeg_-1903970910.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class RestrictedFINXMax31TextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;RestrictedFINXMax31Text&apos; should be formatted.
