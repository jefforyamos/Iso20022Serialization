...
//
// Generated by SimpleTypeSerializationClassGenerator for RestrictedFINXMax520Text.  ISO2002 ID# _K_lY8Q71EeuZI5Sr_GAcuA.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class RestrictedFINXMax520TextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;RestrictedFINXMax520Text&apos; should be formatted.
