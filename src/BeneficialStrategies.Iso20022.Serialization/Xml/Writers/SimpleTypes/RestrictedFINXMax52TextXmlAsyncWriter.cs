...
//
// Generated by SimpleTypeSerializationClassGenerator for RestrictedFINXMax52Text.  ISO2002 ID# _7XZMQfygEeiM0vtizCHcoA.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class RestrictedFINXMax52TextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;RestrictedFINXMax52Text&apos; should be formatted.
