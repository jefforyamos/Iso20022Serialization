...
//
// Generated by SimpleTypeSerializationClassGenerator for RestrictedFINZMax2048Text.  ISO2002 ID# _GtejUA-IEeqIo4c3ferchw.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class RestrictedFINZMax2048TextXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;RestrictedFINZMax2048Text&apos; should be formatted.
