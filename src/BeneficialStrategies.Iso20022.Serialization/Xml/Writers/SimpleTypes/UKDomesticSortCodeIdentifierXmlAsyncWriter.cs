...
//
// Generated by SimpleTypeSerializationClassGenerator for UKDomesticSortCodeIdentifier.  ISO2002 ID# _YXIoEtp-Ed-ak6NoX_4Aeg_-870708017.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class UKDomesticSortCodeIdentifierXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;UKDomesticSortCodeIdentifier&apos; should be formatted.
