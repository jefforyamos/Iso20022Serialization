...
//
// Generated by SimpleTypeSerializationClassGenerator for YesNoIndicator.  ISO2002 ID# _YXbjA9p-Ed-ak6NoX_4Aeg_-2040117978.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class YesNoIndicatorXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;YesNoIndicator&apos; should be formatted.
