...
//
// Generated by SimpleTypeSerializationClassGenerator for anySimpleType.  ISO2002 ID# anySimpleType_ID.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class anySimpleTypeXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;anySimpleType&apos; should be formatted.
