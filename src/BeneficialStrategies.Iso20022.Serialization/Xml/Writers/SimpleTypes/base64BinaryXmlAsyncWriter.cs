...
//
// Generated by SimpleTypeSerializationClassGenerator for base64Binary.  ISO2002 ID# base64Binary_ID.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class base64BinaryXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;base64Binary&apos; should be formatted.
