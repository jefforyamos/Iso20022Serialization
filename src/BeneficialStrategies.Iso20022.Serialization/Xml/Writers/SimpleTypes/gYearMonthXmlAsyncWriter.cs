...
//
// Generated by SimpleTypeSerializationClassGenerator for gYearMonth.  ISO2002 ID# gYearMonth_ID.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class gYearMonthXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;gYearMonth&apos; should be formatted.
