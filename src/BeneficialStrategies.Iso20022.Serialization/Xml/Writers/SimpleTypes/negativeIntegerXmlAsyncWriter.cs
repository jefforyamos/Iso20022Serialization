...
//
// Generated by SimpleTypeSerializationClassGenerator for negativeInteger.  ISO2002 ID# negativeInteger_ID.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class negativeIntegerXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;negativeInteger&apos; should be formatted.
