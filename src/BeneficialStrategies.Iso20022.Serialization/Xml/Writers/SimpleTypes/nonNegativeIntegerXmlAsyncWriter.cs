...
//
// Generated by SimpleTypeSerializationClassGenerator for nonNegativeInteger.  ISO2002 ID# nonNegativeInteger_ID.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class nonNegativeIntegerXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;nonNegativeInteger&apos; should be formatted.
