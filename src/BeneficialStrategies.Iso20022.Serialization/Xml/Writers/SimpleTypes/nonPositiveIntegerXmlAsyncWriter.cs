...
//
// Generated by SimpleTypeSerializationClassGenerator for nonPositiveInteger.  ISO2002 ID# nonPositiveInteger_ID.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class nonPositiveIntegerXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;nonPositiveInteger&apos; should be formatted.
