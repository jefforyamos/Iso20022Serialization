...
//
// Generated by SimpleTypeSerializationClassGenerator for positiveInteger.  ISO2002 ID# positiveInteger_ID.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class positiveIntegerXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;positiveInteger&apos; should be formatted.
