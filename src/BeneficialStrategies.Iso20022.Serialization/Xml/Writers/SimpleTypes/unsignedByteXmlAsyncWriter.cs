...
//
// Generated by SimpleTypeSerializationClassGenerator for unsignedByte.  ISO2002 ID# unsignedByte_ID.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class unsignedByteXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;unsignedByte&apos; should be formatted.
