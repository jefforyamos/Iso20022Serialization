...
//
// Generated by SimpleTypeSerializationClassGenerator for unsignedInt.  ISO2002 ID# unsignedInt_ID.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class unsignedIntXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;unsignedInt&apos; should be formatted.
