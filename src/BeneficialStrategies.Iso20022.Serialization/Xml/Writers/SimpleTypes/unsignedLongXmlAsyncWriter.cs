...
//
// Generated by SimpleTypeSerializationClassGenerator for unsignedLong.  ISO2002 ID# unsignedLong_ID.
...
namespace BeneficialStrategies.Iso20022.Serialization.Xml.Writers.SimpleTypes
{
    ...
    /// </summary>
    public class unsignedLongXmlAsyncWriter : ISimpleTypeSubordinateXmlAsyncWriter<System.String>
    {
        
        // Create a constructor with an injected logger if contents are modified during serialization.
        
        /// <summary>
        /// Write the value to the output the way ISO20022 says a &apos;unsignedLong&apos; should be formatted.
